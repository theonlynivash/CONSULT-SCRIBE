...
export default function NavBar() {
  ...
  // Closing on route change means the menu never stays open after tapping a
  // link, and closing on any viewport resize past mobile width means it
  // can't get stuck open if someone rotates their phone or resizes back up.
  useLayoutEffect(() => {
    setMenuOpen(false);
  }, [location.pathname]);
